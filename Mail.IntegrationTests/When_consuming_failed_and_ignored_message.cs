...
{
    [TestClass]
    public class When_consuming_failed_and_ignored_message
    {
        ...
        public void TestInitialize()
        {
            ...
            _consumer = new TestingConsumer(failure: true, handling: false);
            ...
            Wait.For(TimeSpan.FromSeconds(20)).Until(() => _consumer.Count > 0);
        }
